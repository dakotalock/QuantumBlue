...
!gdown https://drive.google.com/file/d/1JAOV6DO84xcPqfhsZNgRdIKswd0BCc8D/view?usp=drive_link --fuzzy -O QuantumBlueMagnus.dill
...
# Piece-Square Tables, adapted from Sunfish
...
# map piece type string to chess.Piece
...
for k in pst.keys():
    ...
    arr = np.array(pst[k]).reshape(8, 8)

    arr = np.flipud(arr)

    new_pst[piece_mapping[k]] = arr
...
def Qfish_Evaluation(board):
    ...
    for piece_type in piece_values.keys():
        ...
        for square in board.pieces(piece_type, chess.WHITE):
            ...
            score += piece_values[piece_type]  # Material Score
            ...
            if piece_type in pst:
                ...
                score += pst[piece_type][square // 8][square % 8]
        ...
        for square in board.pieces(piece_type, chess.BLACK):
            ...
            if piece_type in pst:
                ...
                score -= pst[piece_type][7 - square // 8][square % 8]
